...
\end{equation}
This decomposition is computed with an FFT and is highly accurate
![](https://res.cloudinary.com/df9pocq2o/image/upload/v1748004178/PK_cheb_twcp45.png){width="500" height="250"}
![](https://res.cloudinary.com/df9pocq2o/image/upload/v1748004069/PK_residuals_o1q1se.png){width="500" height="100"}

:::

::: {.column width="40%"}
![](https://res.cloudinary.com/df9pocq2o/image/upload/v1748003256/chiarenza_mugshot_hcf0q3.png)
:::
::::
