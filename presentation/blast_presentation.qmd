...
:::  {.box style="--box-height: 19px; --box-color: royalblue;" .fragment .fade-in fragment-index=1}
:::
:::

::: {.absolute top="30.5%" left="52%" width="140px"}
:::  {.box style="--box-height: 60px; --box-color: royalblue;" .fragment .fade-out fragment-index=1}
:::
:::
