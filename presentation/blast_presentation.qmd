...
<div class="column" style="width:40%; transform:translateY(+38%);line-height:1.1;">
  <p>There are a few points we wanted to improve</p>
  <ul>
...
&\approx\sum_{n=0}^{N_{\max }} c_n\left(\chi_1, \chi_2; \theta\right) \int d k\, k^2 T_n(k) j_{\ell}\left(k \chi_1\right) j_{\ell}\left(k \chi_2\right) = \sum_{n=0}^{N_{\max }} c_n\left(\chi_1, \chi_2; \theta\right) \tilde{T}_n(k)
\end{align}

. . .

::: {.absolute top="72%" left="12%" width="33px"}
:::  {.box style="--box-height: 19px; --box-color: royalblue;"}
:::
:::

::: {.absolute top="72%" left="40.5%" width="33px"}
:::  {.box style="--box-height: 19px; --box-color: royalblue;"}
:::
:::

::: {.absolute top="83.5%" left="34.9%" width="33px"}
:::  {.box style="--box-height: 19px; --box-color: royalblue;"}
:::
:::

::: {.absolute top="83.5%" left="91%" width="33px"}
:::  {.box style="--box-height: 19px; --box-color: royalblue;"}
:::
:::
...
\begin{equation}
w_{\ell}\left(\chi_1, \chi_2; \theta\right)= \sum_{n=0}^{N_{\max }} c_n\left(\chi_1, \chi_2; \theta\right) \tilde{T}_n(k)
\end{equation}
...
<div class="column" style="width:30%; transform:translateY(+35%);line-height:1.1;">
  <p>Blast.jl is faster and has a better scaling with the number of threads.</p>
...
<div class="column" style="width:30%; transform:translateY(+50%);line-height:1.1;">
  <p>The main contributions do not depend on the number of bins!</p>
  <p>Advantageous when several bins/observables are considered!</p>
</div>
...
|------------------------------|----------|-----------------|---------------|---------------|
| jaxcosmo+Cosmopower-Jax, [Campagne et al., 2023](jjj), [Piras et al., 2025](kkk)      | A100 80 GB GPU   | No      | WL, IA, GC     | 15 s       |
...
Blast.jl is the fastest and most complete of the differentiable $3\times2\,\mathrm{pt}$ codes
...
- Developed a new Non Limber code for $3\times2$point :white_check_mark:
...
- Jax version and inclusion within cloelib :hourglass_flowing_sand:
- Inclusion the Bispectrum :hourglass_flowing_sand:
