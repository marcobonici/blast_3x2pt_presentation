...
<div class="column" style="width:40%; transform:translateY(+38%);line-height:1.1;">
  ...
  <ul>
    ...
    <li class="fragment" data-fragment-index="3">Autodifferentiable</li>
  </ul>
</div>
...
<div class="column" style="width:30%; transform:translateY(+50%);line-height:1.1;">
  ...
  <p>Advantegeous when several bins/observables are considered!</p>
</div>
...
- Inclusion of additional effects and vaidation with external codes :hourglass_flowing_sand:
...
- Extension of the algorithm to the Bispectrum :hourglass_flowing_sand:
:::
